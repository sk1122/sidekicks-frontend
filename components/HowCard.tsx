...
const HowCard = (props: Props) => {
	return (
		<div className="w-full h-full flex flex-col lg:flex-row justify-center items-center px-16 md:px-20 lg:px-40">
			<div className="w-full md:w-1/2 h-full flex flex-col justify-center items-start">
				...
				<p className="w-1/2 text-sm font-medium">{props.desc}</p>
			</div>
