const Hero = () => {
	return (
		<div className="w-full min-h-screen flex flex-col justify-start pt-5 md:pt-10 lg:pt-20 items-center bg-gradient">
			<img src="/sidekicks.png" className='w-fit h-fit' alt="" />
			<div className="w-full h-full flex flex-col lg:flex-row justify-center items-center px-16 md:px-20 lg:px-40 space-y-10 md:space-y-0">
